        ...
        <section className="bg-gray-100 py-16">
            <div className="container mx-auto px-4">
                <div className="text-left mb-12">
                     <h2 className="text-3xl font-bold text-cyan-800 border-b-4 border-cyan-500 inline-block pb-2">PARTNERSHIP</h2>
                </div>
                <div className="flex justify-around items-center flex-wrap gap-8 mb-16">
                    {PARTNER_LOGOS.map((logo, index) => (
                        <img key={index} src={logo} alt={`Partner logo ${index + 1}`} className="h-12 object-contain" />
                    ))}
                </div>
                <div className="relative h-[500px] bg-gray-300 rounded-lg shadow-lg overflow-hidden">
                    <iframe
                    ...
                    ></iframe>
                    <div className="absolute top-10 left-10 bg-cyan-800 text-white p-8 rounded-lg shadow-xl w-full max-w-sm">
                        <h3 className="text-2xl font-bold mb-6 border-b-2 border-cyan-600 pb-2">WORKING HOURS</h3>
                        <div className="flex justify-between items-center mb-8">
                            <span>Mon - Sunday</span>
                            <span className="font-semibold bg-cyan-600 px-3 py-1 rounded-full">24 hours</span>
                        </div>
                        <h3 className="text-2xl font-bold mb-6 border-b-2 border-cyan-600 pb-2">CONTACT DETAILS</h3>
                        <ul className="space-y-4">
                            ...
                            <li className="flex items-center gap-4">
                                <MailIcon />
                                <a href={`mailto:${CONTACT_INFO.email}`} className="hover:text-cyan-300">{CONTACT_INFO.email}</a>
                            </li>
                            <li className="flex items-center gap-4">
                                <CalendarIcon />
