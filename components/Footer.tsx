...
const Logo = () => (
    <a href="#home" className="flex items-center space-x-3">
        ...
        <span className="text-xl font-bold tracking-wide">MOUNTY HEALTH CENTER</span>
    </a>
);
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    ...
                    <div>
                        ...
                        <ul className="space-y-3 text-gray-400 text-sm">
                            ...
                            <li>Email: <a href={`mailto:${CONTACT_INFO.email}`} className="hover:text-white">{CONTACT_INFO.email}</a></li>
