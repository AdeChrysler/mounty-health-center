...
const HomeCareIcon = () => (
    <svg className="w-40 h-40 text-cyan-700" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row items-center gap-12">
          <div className="md:w-1/2 text-left">
            <h2 className="text-2xl sm:text-3xl font-bold text-cyan-800 mb-4">FREE HOME DELIVERY</h2>
          ...
          <div className="md:w-1/2">
            <div className="relative rounded-xl shadow-2xl bg-cyan-50 flex items-center justify-center p-8 h-[350px]">
              <div className="text-center text-cyan-800">
                  <HomeCareIcon />
                  <h3 className="text-2xl font-semibold tracking-widest mt-4">SPECIAL OFFER</h3>
                  <p className="text-3xl sm:text-4xl font-bold my-2">FREE HOME SERVICE</p>
                  <p className="text-xl font-light tracking-widest">EVERYWHERE!</p>
              </div>
            </div>
          </div>
        </div>
