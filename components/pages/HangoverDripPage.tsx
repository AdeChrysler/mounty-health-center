...
const ImmuneBoosterPage = () => {
    return (
        <div className="bg-white animate-fade-in">
            ...
            <section className="relative py-20 md:py-28 bg-cover bg-center text-white" style={{ backgroundImage: "url('https://images2.imgbox.com/d3/55/A9ZvstBm_o.jpg')" }}>
                <div className="absolute inset-0 bg-black/60"></div>
                <div className="container mx-auto px-4 relative z-10 text-center">
                    <h1 className="text-4xl sm:text-5xl font-extrabold mb-4 leading-tight tracking-tight">Immune Booster IV Drip</h1>
            ...
            <section className="py-16 md:py-20">
                <div className="container mx-auto px-4">
                    <div className="grid md:grid-cols-2 gap-12 lg:gap-16 items-center">
                        <div>
                            <h2 className="text-3xl font-bold text-cyan-800 mb-4">Fortify Your Body's Natural Shield</h2>
