    ...
    return (
        <>
            ...
            <a 
                ...
                className="fixed bottom-6 right-6 bg-green-500 hover:bg-green-600 text-white w-16 h-16 rounded-full flex items-center justify-center shadow-lg z-40 transform hover:scale-110 transition-transform"
            ...
            <div className="fixed bottom-6 left-6 z-40">
                <button className="bg-white text-gray-700 px-4 py-2 rounded-md shadow-md flex items-center space-x-2 text-sm font-semibold hover:bg-gray-100">
                    <span>EN</span>
