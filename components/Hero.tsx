      ...
      <div className="container mx-auto px-4 py-20 md:py-32 relative z-10">
        <div className="flex flex-col md:flex-row items-center">
          ...
          <div className="md:w-1/2 text-white md:pl-12 text-center md:text-left">
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-extrabold mb-4 leading-tight tracking-tighter">
              MOUNTY HEALTH CENTER
            </h1>
            <p className="text-base sm:text-lg md:text-xl mb-8 font-light">
